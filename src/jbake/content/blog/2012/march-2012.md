...
abstract=Introduction to the high level concepts of Scala.
date=2012-03-07
type=post
tags=blog
status=published
...
[Scala](http://scala-lang.org) is a general purpose programming language, smoothly integrating object-oriented and functional paradigms. Code compiles down to Java compatible byte code and runs on the JVM. It has become the foundation for high transaction organizations such as Twitter and FourSquare.
